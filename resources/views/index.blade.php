...
<body>
    ...
    <div class="no-margin">
        ...
        {{-- Content 2 --}}
        <div class="px-4 py-5 my-auto text-center container-fluid backgroundColorTertiary">
                ...
                <div class="row row-cols-2 row-cols-lg-2 align-items-stretch g-4 py-5">
                    <div class="col">
                        <div class="card card-cover h-100 overflow-hidden rounded-4 shadow-lg backgroundColorSenary"
                            ...
                            <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                                <img src="{{ asset('images/group 1.png') }}" alt="Bootstrap" width="115"
                                    height="115" class="rounded mx-auto d-block">
                    ...
                    <div class="col">
                        <div class="card card-cover h-100 overflow-hidden backgroundColorSeptary rounded-4 shadow-lg">
                            <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                                <img src="{{ asset('images/group 2.png') }}" alt="Bootstrap" width="115"
                                    height="115" class="rounded mx-auto d-block">
        ...
        {{-- Content 3 --}}
        <div class="px-4 py-5 my-auto container-fluid backgroundColorSecondary">
            <h1 class="display-6 fw-bolder tertiaryColor text-center">About Us</h1>
